...
export const InfoTooltip: React.FC<InfoTooltipProps> = ({ content, className = '', side = 'top', children }) => {
  return (
    <div className={`group relative inline-flex items-center justify-center cursor-help ${className}`}>
      {children ? children : <HelpCircle className="w-3.5 h-3.5 text-zinc-400 hover:text-primary-500 transition-colors" />}
